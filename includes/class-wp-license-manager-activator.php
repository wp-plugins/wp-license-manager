...
class Wp_License_Manager_Activator {
    ...
    /**
     * The database version number. Update every time you make a change to the database structure.
     *
     * @since    1.0.0
     * @access   protected
     ...
     *
     * Creates or updates the database structure required by the plugin.
	 *
	 * @since    1.0.0
	 */
    ...
    /**
     * Creates the database tables required for the plugin if they don't exist. Otherwise updates
     * them as needed.
     *
